...
public class ExampleTestQueries {
	...
	public void testR4() {
		...
		assertEquals("Wrong number of mountain huts in altitude range 0-1000", Long.valueOf(28), res3.get("0-1000"));
		...
		assertEquals("Wrong number of maximum beds number in altitude range 0-1000", Integer.valueOf(89),
